...
function Builder(argv, options) {
  ...
  // temp compatybility with older grunt task
  if (options.buildMode) {
    options.includeTypes = options.buildMode;
  }
  ...
  if (options.disableUI) {
    ...
    this.showUIPrompt(function(selected) {
      ...
      options.includeTypes = ['validator', 'renderer', 'editor'];
